print("LOADED BaseAviary FROM:", __file__)
import os
...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(os.path.join(os.path.dirname(__file__), "assets", self.URDF),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(os.path.join(os.path.dirname(__file__), "assets", self.URDF)).getroot()
